...
export class MatchOnline extends Phaser.Scene
{
    ...
    sendCharacterInfo()
    {
        ...
        if(id == "0")
        {
            ...
            message = {
                id: id,
                frameCharacter: this.Player1.player.frame.name,
        ...
        else if (id == "1")
        {
            ...
            message = {
                id: id,
                frameCharacter: this.Player2.player.frame.name,
...
function updatePlayerInfo(data)
{
    if (id == "0")
    {
        ...
        this.Player2.player.setFrame(data.frameCharacter);
        this.Player2.player.setPosition(data.positionX,data.positionY);
        this.Player2.isAttacking=data.isAttacking;
    ...
    } else if (id == "1")
    {
        ...
        this.Player1.player.setFrame(data.frameCharacter);
        this.Player1.player.setPosition(data.positionX,data.positionY);
        this.Player1.isAttacking=data.isAttacking;
    }
}
