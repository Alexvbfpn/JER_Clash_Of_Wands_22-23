...
var player2Type;
var confirmed;
export class OnlineRuneManager {
    ...
    create()
    {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            currentRune.sprite.on('pointerdown', function () {
                ...
                if (currentRune.isSelected == false && !confirmed) {
            ...
            this.confirm_button.on('pointerdown', function () {
                ...
                this.visible = false;
                confirmed = true;
                selector.currentText.setFrame(5);
            });

            currentRune.sprite.on('pointerover', function () {
                if (currentRune.isSelected == false && lightAgain == true && !confirmed) {
                    onS.play();
                    currentRune.sprite.setFrame(1);
            ...
            currentRune.sprite.on('pointerout', function () {
                if (!currentRune.isSelected && !confirmed) {
                    currentRune.sprite.setFrame(0);
                    selector.currentCharacter.visible = false;
                    selector.currentText.setFrame(0);

                }
                if (currentSelected != null && !confirmed) {
